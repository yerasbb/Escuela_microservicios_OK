...
public class SecurityConfig extends WebSecurityConfigurerAdapter{
	...
	//y que haga el la inyección de dependencias, en lugar
	//de cogerlo nosotros aquí mismo.
	@Autowired
	public BCryptPasswordEncoder encoder;
	
	//Este método es llamado una única vez
	//para instanciar un único encriptador que será usado allá donde se necesite.
	@Bean
	...
	protected void configure(AuthenticationManagerBuilder auth) 
		...
		auth.userDetailsService(srvUsu).passwordEncoder(encoder);
