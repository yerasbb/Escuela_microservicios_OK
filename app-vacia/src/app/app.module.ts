...
//Esto se podría definir en un fichero externo
...
@NgModule({
    ...
    declarations: [AppComponenteA,AppComponenteB,AppComponenteC,PagNoEncontradaComponent, RaizComponent],
    imports:[BrowserModule, RouterModule.forRoot(rutasApp,
